        ...
        <div className="rounded-2xl border border-border bg-card p-5 shadow-[0_1px_0_rgba(15,23,42,0.03)] sm:p-8">
          ...
          <div className="mt-6 grid gap-3">
            <Link
              ...
              className="inline-flex min-h-12 items-center justify-between gap-2 rounded-lg bg-primary px-4 py-3 text-base font-semibold text-primary-foreground shadow-sm transition hover:bg-primary-hover"
            >
              Iniciar cadastro
            ...
            <Link
              to="/admin"
              className="inline-flex min-h-12 items-center justify-between gap-2 rounded-lg border border-border bg-white px-4 py-3 text-base font-medium text-foreground transition hover:border-primary/40 hover:bg-accent"
            >
